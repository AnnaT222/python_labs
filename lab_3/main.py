def vector_matrix_multiply(vector, matrix):
    if len(vector) != len(matrix):
        raise ValueError(
            "Number of columns in the matrix must be equal to the length of the vector."
        )
...
print(
    f"The result of the vector-matrix multiplication has been written to {output_filename}."
)
